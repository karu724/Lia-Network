...
function populateSettingsUpdateInformation(data){
    if(data != null){
        settingsUpdateTitle.innerHTML = `${isPrerelease(data.version) ? 'Pre-release' : 'Release'}이 존재합니다.`
        ...
        if(process.platform === 'darwin'){
            settingsUpdateButtonStatus('깃허브로 부터 다운로드 중<span style="font-size: 10px;color: gray;text-shadow: none !important;">Close the launcher and run the dmg to update.</span>', false, () => {
        ...
        settingsUpdateTitle.innerHTML = '최신 버전에서 실행중입니다.'
